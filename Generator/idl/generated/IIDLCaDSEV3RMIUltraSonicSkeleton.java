 ...
 *
 */
public class IIDLCaDSEV3RMIUltraSonicSkeleton {

	private final static String ServiceClass = "InterfaceIIDLCaDSEV3RMIUltraSonic";
	 ...
	 * @param fifo
	 */
	public IIDLCaDSEV3RMIUltraSonicSkeleton(FifoQueue fifo) {
		this.fifo = fifo;
